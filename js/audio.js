...
// 后台音乐列表
let musicData = [['在东北的小偶像', 'Moon'], ['霓虹甜心', 'Moon'], ['恋爱告急', 'Moon'], ['快点告诉你', 'Moon'], ['拜托丘比特', 'Moon'], ['不如回家喝自来水', 'Moon'], ['童话镇', 'Moon'], ['心电心', 'Moon'], ['羊羊小心愿', 'Moon'], ['说爱你', 'Moon'], ['膨胀', 'Moon'], ['妈妈乐疯狂', 'Moon'], ['咖喱咖喱', 'Moon'], ['谷雨', 'Moon']];
...
function initMusic() {
    ...
    audio.ondurationchange = function () {
        ...
        recordImg.style.backgroundImage = "url('img/record0.jpg')";
...
mode.addEventListener('click', function (event) {
    ...
    mode.style.backgroundImage = "url('img/mode" + modeId.toString() + "1.png')";
});
